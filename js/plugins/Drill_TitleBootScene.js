 ...
 * 1.插件的作用域：菜单界面。
 *   作用于游戏的启动界面。
 * 2.视频动画只支持.webm 和.mp4 格式的视频。
 * 3.注意，全屏模式在win7操作系统中不一定有效，可能会变回窗口模式。
 *   这里的窗口配置都只修改 缩放 的高宽，
 *   如果要改分辨率，需要去 系统-引擎核心 中修改屏幕高宽。
 * 4.你可以设置阶段必须让玩家看几秒才可跳过。比如一些故事介绍或者影片介绍等。
 *   插件中的阶段依次播放，你可以将动画、GIF、视频都配置在启动内容中。
 * 
 * -----------------------------------------------------------------------------
 * ----关联文件
 * 资源路径：img/titles2

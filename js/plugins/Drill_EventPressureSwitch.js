 ...
 * 1.插件的作用域：地图界面。
 *   只作用于事件。
 * 2.重力开关可以做有按下与弹起的缓冲过程，需要你新写事件页来控制。
 * 3.重力开关的注释，最好在事件页ON与OFF处都写。
 * 4.重力开关二次迭代可以制作成脉冲开关，详细原理见docx文档。
 * 5.队伍跟随的成员不会对重力开关有任何影响，只有领队与npc可以。
 * 6.你还可以设置只有含指定重力钥匙的事件，压在上面才可以开启指定重力锁的事件。
 *
 * -----------------------------------------------------------------------------
 * ----激活条件

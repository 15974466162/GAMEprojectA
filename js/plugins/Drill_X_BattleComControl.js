...
Game_System.prototype.initialize = function() {
	...
	this._drill_XBCC_availables = [];
	this._drill_XBCC_enables = [];
	for( var i = 0; i < $dataActors.length; i++ ){	//物品
		this._drill_XBCC_availables[i] = [false,false,false];
		this._drill_XBCC_enables[i] = [false,false,false, 
...
Window_ActorCommand.prototype.addAttackCommand = function() {
	if( $gameSystem._drill_XBCC_availables[this._actor._actorId][0] ){	//插件指令检查
		return;
	}
...
Window_ActorCommand.prototype.addGuardCommand = function() {
	if( $gameSystem._drill_XBCC_availables[this._actor._actorId][1] ){	//插件指令检查
		return;
	}
...
Window_ActorCommand.prototype.addItemCommand = function() {
	if( $gameSystem._drill_XBCC_availables[this._actor._actorId][2] ){	//插件指令检查
		return;
	}
